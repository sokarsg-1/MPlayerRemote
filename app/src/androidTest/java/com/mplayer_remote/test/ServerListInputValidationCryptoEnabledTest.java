...
public class ServerListInputValidationCryptoEnabledTest extends ActivityInstrumentationTestCase2<ServerList> {
		//w celach diagnostycznych nazwa logu dla tej TestCaseClass
	private static final String TAG = "ServerListInputValidationTestCryptoEnabledTest";	
	...
	public ServerListInputValidationCryptoEnabledTest() {
	...
	protected void setUp() throws Exception{
	    ...
	    char[] appPasswordcharArray = "testpassword".toCharArray();
	    com.mplayer_remote.ServerList.setappPasswordcharArrayForTesting(appPasswordcharArray);
		assertTrue(Arrays.equals("testpassword".toCharArray(), com.mplayer_remote.ServerList.getappPasswordcharArrayForTesting()));
	...
	//Nie testuje poprawności server_name(dowolna nazwa tylko dla celów nazwania buttona) oraz username i password ponieważ różne systemy unixowe stosują różne polityki odnośnie jakie znaki i ile można stosować w tych nazwach.
			//whitespace character test
	/*
	public void testWhitespaceCharacterIndialog_ADD_NEW_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_add_new_server));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.title_for_dialog_ADD_NEW_SERVER_CRYPTO_ENABLED)));
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.IP_addressEditText_crypto_enabled);
		solo.enterText(testedEditText, "255.255.255.255");
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.server_nameEditText_crypto_enabled);
		solo.enterText(testedEditText, "test server name");
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.usernameEditText_crypto_enabled);
		solo.enterText(testedEditText, "test_username");
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.passwordEditText_crypto_enabled);
		solo.enterText(testedEditText, "test_password");
		solo.clickOnButton(solo.getString(com.mplayer_remote.R.string.text_for_saveButton_crypto_enabled));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.text_for_toast_fields_should_not_contain_a_whitespace_character)));
		assertFalse(solo.searchText(solo.getString(com.mplayer_remote.R.string.text_for_toast_fill_up_the_empty_spaces)));
		assertFalse(solo.searchText(solo.getString(com.mplayer_remote.R.string.text_for_toast_correct_IP_address)));	
	}
	*/
			//test that no field can by empty in dialog_ADD_NEW_SERVER_CRYPTO_ENABLED()
	public void testZeroLengthserver_nameEditTextIndialog_ADD_NEW_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_add_new_server));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.title_for_dialog_ADD_NEW_SERVER_CRYPTO_ENABLED)));
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.IP_addressEditText_crypto_enabled);
		solo.enterText(testedEditText, "255.255.255.255");
	...
	public void testZeroLengthIP_addressEditTextIndialog_ADD_NEW_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_add_new_server));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.title_for_dialog_ADD_NEW_SERVER_CRYPTO_ENABLED)));
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.IP_addressEditText_crypto_enabled);
		solo.enterText(testedEditText, "");
	...
	public void testZeroLengthusernameEditTextIndialog_ADD_NEW_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_add_new_server));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.title_for_dialog_ADD_NEW_SERVER_CRYPTO_ENABLED)));
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.IP_addressEditText_crypto_enabled);
		solo.enterText(testedEditText, "255.255.255.255");
	...
	public void testZeroLengthpasswordEditTextIndialog_ADD_NEW_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_add_new_server));
		assertTrue(solo.searchText(solo.getString(com.mplayer_remote.R.string.title_for_dialog_ADD_NEW_SERVER_CRYPTO_ENABLED)));
		testedEditText = (EditText)solo.getView(com.mplayer_remote.R.id.IP_addressEditText_crypto_enabled);
		solo.enterText(testedEditText, "255.255.255.255");
	...
	public void testZeroLengthserver_name_in_dialog_edit_server_EditText_crypto_enabled_from_edit_serverIndialog_EDIT_SERVER_CRYPTO_ENABLED(){
	...
	public void testZeroLengthIP_address_in_dialog_EditText_crypto_enabled_from_edit_serverIndialog_EDIT_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_edit_server));
		//kliknięcie w dialog_CHOSE_SERVER_TO_EDIT
		solo.clickInList(0);
	...
	public void testZeroLengthusername_in_dialog_edit_server_EditText_crypto_enabled_from_edit_serverIndialog_EDIT_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_edit_server));
		//kliknięcie w dialog_CHOSE_SERVER_TO_EDIT
		solo.clickInList(0);
	...
	public void testZeroLengthpassword_in_dialog_edit_server_EditText_crypto_enabled_from_edit_serverIndialog_EDIT_SERVER_CRYPTO_ENABLED(){
		solo.clickOnMenuItem(solo.getString(com.mplayer_remote.R.string.title_for_menu_item_edit_server));
		//kliknięcie w dialog_CHOSE_SERVER_TO_EDIT
		solo.clickInList(0);
